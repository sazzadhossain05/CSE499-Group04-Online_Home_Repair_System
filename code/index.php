        ...
        <div class="site-content-wrapper">
            ...
            <div class="site-content">
                    ...
                    <div class="container">
                        ...
                        <div class="card-wrapper flex">
                            <div class="service-card magic-shadow-sm">
                                ...
                                <h2>Plumbing and Sanitary Services</h2>
                                <p>Remember when it’s time to call a Plumber, We make connection between you and the best plumbing experts to get all your plumbing troubles fixed. 
								   Handy Fix, has recruited the best plumber for all plumbing, repairing and maintenance services. 
								   After getting the call or order from the online platform, respective persons will be sent to your home as soon as possible.</p>
                                <button class="btn btn-secondary">Get Service</button>
                            </div>
                            
                            <div class="service-card magic-shadow-sm">
                                <img class="icon" src="./icons/usd.svg" alt="">
                                <h2>Electrical Services</h2>
                                <p>Don’t endanger your life, just for saving a little amount of money.
								Call Handy Fix to get an effective solution for all of your residential and commercial electrical needs. 
								Handy Fix has recruited the best technicians for all Electrical repairing and maintenance services.
								Experts will check and find the problems of your electrical device or machinery and give a better solution as per the requirement.</p>
                                <button class="btn btn-secondary">Get Service</button>
                            </div>
                        </div>
                    </div>
                ...
                <section class="top-products">
                    <div class="container">
                        <h1 class="section-heading">Top Service</h1>
                        <div class="slider">
                            ...
                            <div class="food-slider">
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center">Complete New Plumbing System Installation</h2>
                                ...
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center">Plumbing System Diagnosis and Inspections</h2>
                                        <div class="stars flex justify-center items-center">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                ...
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center">Water Leak Repair</h2>
                                        <div class="stars flex justify-center items-center">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                ...
                                <div class="food-card magic-shadow-sm">
                                    ...
                                    <hr>
                                    <div>
                                        <h2 class="text-center">Complete New Electric Systems Installation</h2>
                                        <div class="stars flex justify-center items-center">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                                            <img src="./icons/start-filled.svg" alt="">
                ...
                <section class="about-meal">
                    <div class="container">
                        <h1 class="section-heading">WHAT IS Handy Fix</h1>
                        <div class="about-meal-wrap flex">
                            ...
                            <div class="flex-1">
                                ...
                                <p>
                                    Handy Fix is an online based service platform that offers home services in all areas of Dhaka City. 
                                     We ensure quality service by providing training to our technicians which also emphasis on safety and behavioral aspects. 
									 Apart from the domiciliary service, Handy Fix also provide one-time, periodical subscription for corporate houses.
									 Our highly trained and professional technicians are always a CALL away to provide Electrical and Plumbing servicing works at your doorstep. 
                                      We are also open to provide our services during holidays, mid-nights or your free hours.</p>
                            ...
                            <article class="card magic-shadow-sm">
                                ...
                                <div class="card-content">
                                    <div class="post-meta flex items-center justify-between">
                                        ...
                                        <div>
                                            <span>Posted by <strong>Handy Fix</strong></span>
                                            <span class="comment-count">12 Comments</span>
                                        </div>
                                    </div>

                                    <h2>Virtual handyman service can help you with DIY projects</h2>
                ...
                <section class="subscribe">
                    <div class="container flex items-center">
                        ...
                        <div>
                            ...
                            <p>Subscribe for new news and discount.</p>
                            <div class="input-wrap">
                                <input type="email" placeholder="handyfix@gmail.com">
