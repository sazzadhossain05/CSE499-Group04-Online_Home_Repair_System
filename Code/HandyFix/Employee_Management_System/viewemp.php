...
<html>
<head>
	<title>View Employee |  Admin Panel | HandyFix Employee Management System</title>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homered" href="viewemp.php">View Emp.</a></li>
				<li><a class="homeblack" href="assign.php">Assign Project</a></li>
				<li><a class="homeblack" href="assignproject.php">Project Status</a></li>
				<li><a class="homeblack" href="salaryemp.php">Salary Table</a></li>
				<li><a class="homeblack" href="empleave.php">Emp. Leave</a></li>
				<!--<li><a class="homeblack" href="applicationofserviceman.php">Job App.</a></li>-->
