...
$sql = "SELECT * FROM `serviceprovider` WHERE 1";
...
$result = mysqli_query($conn, "UPDATE `serviceprovider` SET `firstName`='$firstname',`lastName`='$lastname',`email`='$email',`birthday`='$birthday',`gender`='$gender',`contact`='$contact',`nid`='$nid',`address`='$address',`dept`='$dept',`degree`='$degree' ");
	echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Succesfully Updated')
    window.location.href='applicationofserviceman.php';
    </SCRIPT>");
...
<html>
<head>
	<title>View Job Application |  Admin Panel | Employee Management System</title>
	<!-- Icons font CSS-->
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Update Applicant Info</h2>
                    <form id = "registration" action="applicationofservicemanedit.php" method="POST">
